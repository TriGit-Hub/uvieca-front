...
import BannerArea, { Col } from './banner2.style';
...
const Banner = () => {
  ...
  const EleSvg = () => {
    return (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 394.84 333.68">
      <defs>
        <style>
    ...
    <BannerWrapper id="banner_section">
      <Container>
        <Box className="content">
          ...
          <Heading as="h2" content="UVIECA - Erick Esaú Castro Acevedo" />
          ...
          <div style={{
            ...
            <Button className='boton b1' variant="contained">Crear Solicitud</Button>
            <Button className='boton b2' variant="outlined">Nuestros Servicios</Button>
          </div>
        </Box>
        <Box className="image">
          <Fade right>
