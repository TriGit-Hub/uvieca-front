  ...
  posts: [
    {
      ...
      link: '#',
      categories: [
        { name: 'Se instalara lorencuje ewr cewr' },
      
      ],
    },
    {
      image: availableRestaurantImage2,
      title: 'Instalaciones electricas 2',
      link: '#',
      categories: [
        { name: 'Se instalara lorencuje ewr cewr Se instalara lorencuje ewr cewr' },
     
      ],
    },
    {
      image: availableRestaurantImage3,
      title: "Electricas instalaciones",
      link: '#',
      categories: [
        { name: 'Se instalara lorencuje ewr cewrSe instalara lorencuje ewr cewr' },
...
export const BANNER_DATA = {
  ...
  title: 'UVIECA',
  text: 'Servicio de instalaciones electricas.',
